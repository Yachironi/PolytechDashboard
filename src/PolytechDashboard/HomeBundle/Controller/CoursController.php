<?php
// src/PolytechDashboard/HomeBundle/Controller/CoursController.php

namespace PolytechDashboard\HomeBundle\Controller;

use PolytechDashboard\HomeBundle\Entity\Advert;
...
class CoursController extends Controller
{
    public function indexAction($id)
    {
		...
		$cours = $this->getDoctrine()
			->getRepository('PolytechDashboardHomeBundle:Cours')
			->find($id);

		if (!$cours) {
			throw $this->createNotFoundException(
				'Aucun cours trouvé pour cet id : '.$id
			);
		}
