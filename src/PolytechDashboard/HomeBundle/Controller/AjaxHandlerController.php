					...
					foreach ( $destinataire as $dest ) {
						...
						if ($file != null) {
							...
							if (move_uploaded_file ( $_FILES ['userfile'] ['tmp_name'], $uploadfile )) {
								echo "Le fichier est valide, et a �t� t�l�charg� avec succ�s. Voici plus d'informations :\n";
							} else {
								echo "Attaque potentielle par t�l�chargement de fichiers. Voici plus d'informations :\n";
							}
						}
						/* contenu de la tache */
						$tmp = [ ];
