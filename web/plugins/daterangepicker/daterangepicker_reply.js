...
!function ($) {
    ...
    var DateRangePicker_reply = function (element, options, cb) {
    ...
    DateRangePicker_reply.prototype = {

        constructor: DateRangePicker_reply,
    ...
    $.fn.daterangepicker_reply = function (options, cb) {
        this.each(function () {
            var el = $(this);
            if (!el.data('daterangepicker_reply'))
                el.data('daterangepicker_reply', new DateRangePicker_reply(el, options, cb));
        });
        return this;
    };
